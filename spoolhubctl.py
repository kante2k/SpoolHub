...
def generate_klipper_config(args: argparse.Namespace) -> int:
    ...
    lines = [
        ...
        f"# Server: {server}",
        "#",
        "# Requirement: Klipper [save_variables] must be enabled.",
        "# SpoolHub writes spool data to this local file using SAVE_VARIABLE.",
        "# During a print, the macros only read local save_variables.",
        "#",
        "# Include in printer.cfg:",
        f"#   [include {include_path}]",
        "#",
        "# Add only to existing toolhead/tool-change macros:",
        "#   _SPOOLHUB_APPLY_T0",
        "",
    ]
